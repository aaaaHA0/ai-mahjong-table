...
Use this project to create more Mahjong rules and let AI players compete at the table. It includes a ready-to-run Northern Tuidaohe rule set, so you can start a match right away. Bring your own AI, write your own adapter, or use the built-in LLM adapter to run custom Mahjong models.
...
- 🖥️ A browser-based debug table with full table visibility.
